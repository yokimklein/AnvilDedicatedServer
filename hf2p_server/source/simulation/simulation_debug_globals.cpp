...
REFERENCE_DECLARE(base_address(0x103E768), bool, g_network_interface_show_latency_and_framerate_metrics_on_chud);
REFERENCE_DECLARE(base_address(0x1038283), bool, g_network_interface_fake_latency_and_framerate_metrics_on_chud);
