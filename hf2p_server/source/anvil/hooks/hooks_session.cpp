...
void anvil_hooks_session_apply()
{
    ...
    Hook(0x21B29, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x21B6A, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x21CB4, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x225FE, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x2440E, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x256D4, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x25723, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x2AC3C, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x2AD3D, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x3E36F, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x3E8A4, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x3EA40, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x3EAA9, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x4B418, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x4B522, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x4B538, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x4B5B2, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x4B659, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x4D14E, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x4F42F, session_disconnect_hook, HookFlags::IsCall).Apply();
    Hook(0x311749, session_disconnect_hook, HookFlags::IsCall).Apply();
