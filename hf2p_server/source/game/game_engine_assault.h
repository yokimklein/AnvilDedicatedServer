...
struct s_game_engine_assault_variant_definition;
class c_game_engine_assault_variant : public c_game_engine_base_variant
{
public:
	c_game_engine_assault_variant* constructor();

	void set(c_game_engine_assault_variant const* variant, bool force);
	void set(s_game_engine_assault_variant_definition const* definition);
