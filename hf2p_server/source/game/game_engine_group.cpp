...
s_game_engine_settings_definition* game_engine_settings_try_and_get()
{
	...
	if (universal != nullptr)
	{
		...
		if (wezr_index != NONE)
		{
			return (s_game_engine_settings_definition*)tag_get(GAME_ENGINE_SETTINGS_DEFINITION_TAG, wezr_index);
		}
	}
	return nullptr;
}