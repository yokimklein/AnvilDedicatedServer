...
void game_results_statistic_set(datum_index absolute_player_index, e_game_team team_index, long statistic, long value)
{
	...
	const auto game_results_statistic_set_call = (void (*)(datum_index absolute_player_index, e_game_team team_index, long statistic, long value))(module_base + 0xCE0B0);
	__asm
	{
		push value
		push statistic
