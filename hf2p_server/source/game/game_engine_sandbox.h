...
struct s_sandbox_globals
{
	...
	c_static_array<real_vector3d, 16> crosshair_points;
	c_static_array<real_vector3d, 16> crosshair_intersect_normals;
	c_static_array<real_vector3d, 16> crosshair_redirections;
