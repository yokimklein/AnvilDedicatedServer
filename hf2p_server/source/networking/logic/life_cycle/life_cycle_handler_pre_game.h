...
class c_life_cycle_state_handler_pre_game : public c_life_cycle_state_handler
{
public:
...
protected:
	ulong m_last_countdown_timestamp;
	long m_last_countdown_timer;
	ulong m_game_start_timestamp;
};
