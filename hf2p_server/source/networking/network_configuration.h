...
struct s_life_cycle_handler_matchmaking_configuration
{
	...
	ulong matchmaking_start_failure_wait_time_ms;
	ulong matchmaking_find_match_joinable_session_threshold;
	ulong matchmaking_find_match_join_wait_time_ms;
	ulong matchmaking_find_match_search_results_stale_ms;
	ulong matchmaking_gather_join_wait_time_ms;
	ulong matchmaking_search_give_up_time_seconds;
	ulong join_request_wait_time_ms;
	bool prepare_map_display_map_during_loading;
	ulong prepare_map_veto_timer_seconds;
	ulong prepare_map_minimum_load_time_seconds;
	ulong prepare_map_countdown_timer_seconds;
	ulong prepare_map_vetoed_countdown_timer_seconds;
	ulong prepare_map_veto_failed_countdown_timer_seconds;
	ulong end_match_write_stats_boot_threshold_seconds;
	ulong arbitration_wait_for_establishment_and_connectivity_threshold_seconds;
	ulong arbitration_wait_for_completion_threshold_seconds;
	bool post_match_return_to_pre_game_lobby;
	ulong post_match_stats_refresh_time;
	ulong warning_toast_minimum_time_seconds;
};
