...
{
	void(__thiscall* send_message)(c_network_message_queue* thisptr, e_network_message_type message_type, long message_size, s_network_message* message) = reinterpret_cast<decltype(send_message)>(module_base + 0x16BB0);
