...
void c_network_observer::handle_connect_request(s_transport_address const* address, s_network_message_connect_request const* message)
{
	...
	static auto c_network_observer__handle_connect_request = reinterpret_cast<c_network_observer__handle_connect_request_ptr>(base_address(0x10E30));
...
void c_network_observer::observer_channel_initiate_connection(e_network_observer_owner observer_owner, int observer_channel_index)
{
	...
	static auto observer_channel_initiate_connection_call = reinterpret_cast<observer_channel_initiate_connection_call_ptr>(base_address(0xF970));
...
{
	void(__thiscall* observer_channel_send_message)(c_network_observer* observer, e_network_observer_owner owner_type, long observer_index, bool disconnected, e_network_message_type message_type, long message_size, s_network_message* message) = reinterpret_cast<decltype(observer_channel_send_message)>(base_address(0xF440));
...
{
	bool(__thiscall* observer_channel_backlogged)(c_network_observer* observer, e_network_observer_owner owner_type, long observer_index, e_network_message_type message_type) = reinterpret_cast<decltype(observer_channel_backlogged)>(base_address(0xF880));
...
{
	void(__thiscall* observer_channel_set_waiting_on_backlog)(c_network_observer* observer, e_network_observer_owner owner_type, long observer_index, e_network_message_type message_type) = reinterpret_cast<decltype(observer_channel_set_waiting_on_backlog)>(base_address(0xF900));
...
{
	void(__thiscall* quality_statistics_get_ratings)(c_network_observer* observer, ulong* connectivity_badness_rating, ulong* host_badness_rating, ulong* client_badness_rating) = reinterpret_cast<decltype(quality_statistics_get_ratings)>(base_address(0xEF30));
