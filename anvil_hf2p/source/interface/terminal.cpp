...
void terminal_draw(rectangle2d* screen_bounds, rectangle2d* frame_bounds)
{
	if (terminal_globals.initialized)
	{
		...
		rectangle2d render_title_safe_bounds{};
		rectangle2d display_bounds{};
		rectangle2d display_title_safe_bounds{};
		interface_get_current_display_settings(&render_bounds, &render_title_safe_bounds, &display_bounds, &display_title_safe_bounds);
		rectangle2d* pixel_bounds_ = &display_bounds; // 360 builds used display_title_safe_bounds, HO & MCC use display_bounds
