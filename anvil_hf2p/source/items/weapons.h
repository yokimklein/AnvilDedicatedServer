...
struct weapon_barrel
{
	...
	short timer;
	c_flags<e_weapon_barrel_flags, ushort, k_weapon_barrel_flags> flags;
...
struct weapon_trigger
{
	...
	short timer;
	c_flags<e_weapon_trigger_flags, ushort, k_weapon_trigger_flags> flags;
...
{
	c_flags<e_weapon_flags, ushort, k_weapon_flags> flags;
	...
	// if (game_is_multiplayer() && weapon->weapon.team_index != NONE && object_is_ctf_flag(object))
	c_enum<e_game_team, short, _game_team_none, k_maximum_teams> team_index;
