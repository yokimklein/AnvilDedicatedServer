...
extern bool internal_event_wait_timeout(long event_id, ulong timeout_in_milliseconds);
...
extern bool wait_for_single_object_internal(void* handle, ulong timeout_in_milliseconds);
