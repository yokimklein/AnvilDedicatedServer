...
extern bool current_thread_should_exit();
extern bool current_thread_should_assert();
extern bool current_thread_should_crash();
extern void current_thread_update_test_functions();
//extern void __cdecl destroy_thread_management();
extern ulong get_main_thread_id();
extern const char* get_registered_thread_name(long thread_index);
//extern e_thread_processor __cdecl get_registered_thread_processor(e_registered_threads thread_index);
extern const char* get_thread_name_from_thread_id(long thread_id);
//extern void initialize_thread(e_registered_threads thread_index);
...
extern void sleep(ulong milliseconds);
extern void __fastcall start_thread(e_registered_threads thread_index);
extern void stop_thread(e_registered_threads thread_index);
...
extern bool thread_has_crashed(e_registered_threads thread_index);
...
extern void unregister_thread(long thread_index);
extern bool wait_for_thread_to_exit(long thread_index, ulong timeout_in_milliseconds);
...
extern long get_current_thread_index();
extern bool registered_thread_handle_valid(e_registered_threads thread_index);
extern void thread_destroy(void* thread_handle);