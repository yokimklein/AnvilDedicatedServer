...
{
public:
	void staleify_resource_address(datum_index index);
	void mark_required_resource(datum_index index);
	void mark_unrequired_resource(datum_index index);
...
public:
	...
	c_wrapped_array<ulong64> m_cached_resource_snapshots;
