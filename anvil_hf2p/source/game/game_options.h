...
struct game_options
{
	...
	c_enum<e_game_simulation_type, byte, _game_simulation_none, k_game_simulation_count> game_simulation_type;
	...
	c_flags<e_campaign_skulls_primary, long, k_campaign_skulls_primary_count> campaign_active_primary_skulls;
	c_flags<e_campaign_skulls_secondary, long, k_campaign_skulls_secondary_count> campaign_active_secondary_skulls;
