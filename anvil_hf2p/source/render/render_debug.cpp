...
#include "render\render_visibility.h"
...
t_restricted_allocation_manager<k_game_state_shared_region, nullptr, nullptr, __tls_set_g_render_debug_globals_allocator> g_render_debug_globals_allocator;
thread_local s_render_debug_globals* g_render_debug_globals = NULL;

void __cdecl __tls_set_g_render_debug_globals_allocator(void* allocation)
{
	g_render_debug_globals = (s_render_debug_globals*)allocation;
}

void render_debug_initialize()
{
	g_render_debug_globals = (s_render_debug_globals*)g_render_debug_globals_allocator.reserve_memory("render_debug", "global", sizeof(s_render_debug_globals), 0);
...
s_render_debug_globals* get_render_debug_globals()
{
...
bool render_debug_allowed_in_current_thread()
{
	return restricted_region_locked_for_current_thread(k_game_state_render_region) && c_rasterizer::rasterizer_thread_owns_device();
}

bool render_debug_active()
{
	return get_render_debug_globals()->active;
}

bool render_debug_cache_currently_drawing()
{
	return get_render_debug_globals()->drawing_cached_geometry;
}

void render_debug_text_using_simple_font(bool use_simple_font)
{
	get_render_debug_globals()->use_simple_font_text_rendering = use_simple_font;
}

void render_debug_reset_cache_to_game_tick_entires()
{
...
void render_debug_notify_game_tick_begin()
{
	s_render_debug_globals* render_debug_globals = get_render_debug_globals();
...
void render_debug_notify_game_tick_end()
{
	s_render_debug_globals* render_debug_globals = get_render_debug_globals();
...
void rasterizer_debug_line(const real_point3d* p0, const real_point3d* p1, const real_argb_color* color0, const real_argb_color* color1)
{
	ASSERT(p0 && p1 && color0);
...
void rasterizer_debug_line2d(const real_point2d* p0, const real_point2d* p1, const real_argb_color* color0, const real_argb_color* color1)
{
	ASSERT(p0 && p1 && color0);
...
void rasterizer_debug_triangle(const real_point3d* point0, const real_point3d* point1, const real_point3d* point2, const real_argb_color* color)
{
	...
	pixel32 _color = real_argb_color_to_pixel32(color);
...
int render_debug_cache_sort_function(const void* a, const void* b)
{
...
void render_debug_begin(bool render_game_tick_cache, bool only_render_strings, bool clear_cache)
{
	s_render_debug_globals* g_render_debug_globals = get_render_debug_globals();
...
void render_debug_end(bool render_game_tick_cache, bool only_render_strings, bool clear_cache)
{
	s_render_debug_globals* g_render_debug_globals = get_render_debug_globals();
	ASSERT(g_render_debug_globals->active);
...
void render_debug_structure_draw()
{
	// $IMPLEMENT
}

void render_debug_visibility_render()
{
...
void render_debug_clients(long user_index)
{
...
long render_debug_add_cache_string(const char* string)
{
	s_render_debug_globals* render_debug_globals = get_render_debug_globals();
...
{
	return render_debug_unique_color(INTEGER_RANDOM(get_local_random_seed_address(), NULL), color);
}
...
void render_debug_point2d(bool draw_immediately, const real_plane3d* plane, short projection_axis, bool projection_sign, const real_point2d* point, real scale, const real_argb_color* color, real a8)
{
	ASSERT(plane);
	ASSERT(point);
	ASSERT(color);
...
void render_debug_line2d(const real_point2d* point0, const real_point2d* point1, const real_argb_color* color)
{
	ASSERT(point0);
	ASSERT(point1);
	ASSERT(color);
...
void render_debug_line2d(bool draw_immediately, const real_plane3d* plane, short projection_axis, bool projection_sign, const real_point2d* p0, const real_point2d* p1, const real_argb_color* color, real a8)
{
	ASSERT(plane);
	ASSERT(p0);
	ASSERT(p1);
...
void render_debug_vector2d(bool draw_immediately, const real_plane3d* plane, short projection_axis, bool projection_sign, const real_point2d* point, const real_vector2d* vector, real scale, const real_argb_color* color, real a9)
{
	ASSERT(plane);
	ASSERT(point);
	ASSERT(vector);
...
void render_debug_circle(bool draw_immediately, const real_plane3d* plane, short projection_axis, bool projection_sign, const real_point2d* center, real radius, const real_argb_color* color, real a8)
{
	ASSERT(plane);
	ASSERT(center);
	ASSERT(color);
...
void render_debug_circle(bool draw_immediately, const real_point3d* center, const real_vector3d* normal, real radius, const real_argb_color* color)
{
	render_debug_polygon_regular(draw_immediately, center, CIRCLE_DIVISIONS, normal, radius, color);
}

void render_debug_polygon_regular(bool draw_immediately, const real_point3d* center, long point_count, const real_vector3d* normal, real radius, const real_argb_color* color)
{
	ASSERT(center != NULL);
	ASSERT(normal != NULL);
	...
	matrix.vectors.forward = *normal;
	generate_up_vector3d(&matrix.vectors.forward, &matrix.vectors.up);
	cross_product3d(&matrix.vectors.up, &matrix.vectors.forward, &matrix.vectors.left);
...
void render_debug_point(bool draw_immediately, const real_point3d* point, real scale, const real_argb_color* color)
{
	ASSERT(point);
	ASSERT(color);
...
void render_debug_line(bool draw_immediately, const real_point3d* point0, const real_point3d* point1, const real_argb_color* color)
{
	ASSERT(point0);
	ASSERT(point1);
	ASSERT(color);
...
void render_debug_line_shaded(bool draw_immediately, const real_point3d* point0, const real_point3d* point1, const real_argb_color* color0, const real_argb_color* color1)
{
	ASSERT(point0);
	ASSERT(point1);
	ASSERT(color0);
...
void render_debug_line2d_shaded(const real_point2d* point0, const real_point2d* point1, const real_argb_color* color0, const real_argb_color* color1)
{
	ASSERT(point0);
	ASSERT(point1);
	ASSERT(color0);
...
void render_debug_line_unclipped(bool draw_immediately, const real_point3d* point0, const real_point3d* point1, const real_argb_color* color)
{
	ASSERT(point0);
	ASSERT(point1);
...
void render_debug_line_non_occluded(bool draw_immediately, const real_point3d* point0, const real_point3d* point1, const real_argb_color* color)
{
	ASSERT(point0);
	ASSERT(point1);
...
void render_debug_vector(bool draw_immediately, const real_point3d* point, const real_vector3d* vector, real scale, const real_argb_color* color)
{
	ASSERT(point);
	ASSERT(vector);
	ASSERT(color);
...
void render_debug_tick(bool draw_immediately, const real_point3d* point, const real_vector3d* vector, real scale, const real_argb_color* color)
{
	real_point3d point0{};
	real_point3d point1{};
...
void render_debug_line_offset(bool draw_immediately, const real_point3d* point0, const real_point3d* point1, const real_argb_color* color, real scale)
{
	real_point3d p0{};
	real_point3d p1{};
...
void render_debug_vectors(bool draw_immediately, const real_point3d* point, const real_vector3d* forward, const real_vector3d* up, real radius)
{
	real_matrix4x3 matrix{};
...
void render_debug_quaternion(bool draw_immediately, const real_point3d* point, const real_quaternion* quaternion, real radius)
{
	real_matrix4x3 matrix{};
...
void render_debug_matrix(bool draw_immediately, const real_matrix4x3* matrix, real radius)
{
	render_debug_vector(draw_immediately, &matrix->position, &matrix->vectors.forward, radius * matrix->scale, global_real_argb_red);
	render_debug_vector(draw_immediately, &matrix->position, &matrix->vectors.left, radius * matrix->scale, global_real_argb_green);
	render_debug_vector(draw_immediately, &matrix->position, &matrix->vectors.up, radius * matrix->scale, global_real_argb_blue);
}

void render_debug_matrix3x3(bool draw_immediately, const real_matrix3x3* matrix, const real_point3d* point, real radius)
{
...
void render_debug_triangle(bool draw_immediately, const real_point3d* point0, const real_point3d* point1, const real_point3d* point2, const real_argb_color* color)
{
	ASSERT(point0);
	ASSERT(point1);
	ASSERT(point2);
...
void render_debug_triangle_outline(bool draw_immediately, const real_point3d* point0, const real_point3d* point1, const real_point3d* point2, const real_argb_color* color)
{
	ASSERT(point0);
	ASSERT(point1);
	ASSERT(point2);
...
void render_debug_quadrilateral(bool draw_immediately, const real_point3d* point0, const real_point3d* point1, const real_point3d* point2, const real_point3d* point3, const real_argb_color* color)
{
	ASSERT(point0);
	ASSERT(point1);
	ASSERT(point2);
...
void render_debug_sphere(bool draw_immediately, const real_point3d* center, real radius, const real_argb_color* color)
{
	ASSERT(center);
	ASSERT(color);
...
void render_debug_cylinder(bool draw_immediately, const real_point3d* base, const real_vector3d* height, real radius, const real_argb_color* color)
{
	ASSERT(base);
	ASSERT(height);
	ASSERT(color);
...
void render_debug_pill(bool draw_immediately, const real_point3d* base, const real_vector3d* height, real radius, const real_argb_color* color)
{
	ASSERT(base);
	ASSERT(height);
	ASSERT(color);
...
void render_debug_box2d_outline(bool draw_immediately, const real_rectangle2d* bounds, const real_argb_color* color)
{
	ASSERT(bounds);
	ASSERT(color);
...
void render_debug_box(bool draw_immediately, const real_rectangle3d* bounds, const real_argb_color* color)
{
	ASSERT(bounds);
	ASSERT(color);
...
void render_debug_box_oriented(bool draw_immediately, const real_rectangle3d* bounds, const real_matrix4x3* matrix, const real_argb_color* color)
{
	real_point3d faces[k_faces_per_cube_count][4]{};
...
void render_debug_box_outline(bool draw_immediately, const real_rectangle3d* bounds, const real_argb_color* color)
{
	ASSERT(bounds);
	ASSERT(color);
...
void render_debug_box_outline_oriented(bool draw_immediately, const real_rectangle3d* bounds, const real_matrix4x3* matrix, const real_argb_color* color)
{
	ASSERT(bounds);
	ASSERT(matrix);
	ASSERT(color);
...
void render_debug_polygon(const real_point3d* points, short point_count, const real_argb_color* color)
{
	if (point_count > 1)
	{
		ASSERT(points);
...
void render_debug_polygon_edges(const real_point3d* points, short point_count, const real_argb_color* color)
{
	if (point_count > 1)
	{
		ASSERT(points);
...
void render_debug_k_graph(const real_point3d* points, short point_count, const real_argb_color* color)
{
	ASSERT(points);
	ASSERT(color);
	...
	if (point_count > 2)
	{
		...
		{
			for (short j = i + 1; j < point_count; j++)
			{
...
void render_debug_cone_outline(bool draw_immediately, const real_point3d* point, const real_vector3d* direction, real radius, real cone_angle, const real_argb_color* color)
{
...
void render_debug_string_at_point(const real_point3d* point, const char* string, const real_argb_color* color)
{
	ASSERT(point);
	ASSERT(string);
	ASSERT(color);
...
void render_debug_string_immediate(bool draw_immediately, const short* tab_stops, short tab_stop_count, const char* string)
{
	if (string && *string)
	{
...
void render_debug_string_at_point_immediate(const real_point3d* point, const char* string, const real_argb_color* color)
{
	ASSERT(point);
	ASSERT(string);
	ASSERT(color);
	...
	{
		rectangle2d bounds{};
		bounds.x0 = (short)real(screen_point.x - (real)window_display_bounds.x0);
		bounds.y0 = (short)real(screen_point.y - (real)window_display_bounds.y0);
		bounds.x1 = SHRT_MAX;
		bounds.y1 = SHRT_MAX;
...
bool render_debug_draw_immediately(const real_argb_color* color)
{
	ASSERT(g_render_debug_globals);
...
void render_debug_cache_draw(bool render_game_tick_cache, bool only_render_strings, bool clear_cache)
{
	s_render_debug_globals* g_render_debug_globals = get_render_debug_globals();
...
void render_debug_polygon_fan(const real_point3d* points, short point_count, const real_argb_color* color)
{
	if (point_count > 1)
	{
		ASSERT(points);
...
real build_height_matrix(const real_point3d* base, const real_vector3d* height, real_matrix4x3* out_matrix)
{
	out_matrix->scale = 1.0f;
	out_matrix->vectors.up = *height;
	perpendicular3d(&out_matrix->vectors.up, &out_matrix->vectors.left);
	real result = normalize3d(&out_matrix->vectors.up);
	normalize3d(&out_matrix->vectors.left);
	cross_product3d(&out_matrix->vectors.left, &out_matrix->vectors.up, &out_matrix->vectors.forward);
	out_matrix->position = *base;

	return result;
}

void render_debug_build_circle_points(real radius, real_point2d* points, long total_point_count)
{
...
void render_debug_build_pill_points(const real_point3d* base, const real_vector3d* height, real radius, real_point3d* points0, real_point3d* points1, real_point3d* points2, real_point3d* points3, real_point3d* points4, real_point3d* points5)
{
...
real_point3d* rectangle3d_center(const real_rectangle3d* rect, real_point3d* center)
{
